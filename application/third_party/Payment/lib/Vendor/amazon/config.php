...
define('MERCHANT_PROPERTIES_FILE','../Vendor/amazon/prop/merchant.properties');
...
define('ORDER_SCHEMA_FILE',APP_PATH.'Vendor/amazon/schema/order.xsd');


//Path setting
define("LOG_DIR",'../Vendor/amazon/log/');
