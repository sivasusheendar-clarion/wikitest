<?php
//require_once(LIB_PATH . '/Vendor/amazon/config.php');
require_once(LIB_PATH . '/Vendor/amazon/merchant/cart/html/MerchantHTMLCartFactory.php');
require_once(LIB_PATH . '/Vendor/amazon/common/cart/xml/XMLCartFactory.php');
require_once(LIB_PATH . '/Vendor/amazon/common/signature/SignatureCalculator.php');
