<?php
require_once(APP . DS . "Vendor/amazon/common/cart/html/HTMLCartFactory.php");
/**
...
class MerchantHTMLCartFactory extends HTMLCartFactory {
    ...
    */
   public function getCartMap($merchantID, $awsAccessKeyID) {
//      $thiscart = array(
...
//                      "item_quantity_1" => "1"
//                  );
      $this->vals["currency_code"] = "USD";
      $this->vals["aws_access_key_id"] = $awsAccessKeyID;
